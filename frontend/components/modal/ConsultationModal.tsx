...
export default function ConsultationModal({ isOpen, onClose }: ConsultationModalProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success) {
        showSuccess('Consultation request submitted successfully! We\'ll contact you soon.');
        // Reset form
        setFormData({
          phone: "",
          service: "",
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-100">
          <h2 className="text-2xl font-medium text-[#0A438C]">Request A Consultation</h2>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              >
                ...
                <option value="uti">Testing and treatment for UTI</option>
                <option value="strep">Testing and treatment for Strep A</option>
                <option value="travel">Traveller's Health</option>
                <option value="sinus">Sinus Infection</option>
                <option value="allergies">Allergies Treatment</option>
              </select>
          ...
          <div>
            <h3 className="text-lg font-[400] text-[#0A438C] mb-4">Preferred Date and Time</h3>
            <div className="flex gap-3">
              ...
              <div className="flex-1 relative">
                <input
                  ...
                  value={formData.preferredDate ? new Date(formData.preferredDate).toLocaleDateString('en-US', {
                    weekday: 'long',
                    year: 'numeric',
                    month: 'long',
                    day: 'numeric'
          ...
          {/* Additional Note */}
          <div>
            <h3 className="text-lg font-[400] text-[#0A438C] mb-4">Additional Note</h3>
            <textarea
                  ...
                  {generateCalendarDays().map((day, index) => (
                    <button
                      ...
                      className={`p-2 text-sm rounded-lg transition-colors ${
                        day.isAvailable
                          ? formData.preferredDate === day.date.toISOString().split('T')[0]
            ...
            >
              <div className="p-4">
                ...
                <div className="max-h-60 overflow-y-auto">
                  {getAvailableTimes(formData.preferredDate).map((time, index) => (
                    <button
                      key={index}
                      type="button"
                      onClick={() => {
                        setFormData((prev) => ({ ...prev, preferredTime: time.value }));
